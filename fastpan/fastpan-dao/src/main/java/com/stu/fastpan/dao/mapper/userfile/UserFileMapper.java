...
public interface UserFileMapper {
	...
	List<UserFile> selectByUserIdPathState(@Param("userId") String userId, @Param("path") String path,
			@Param("state") Byte state);

	List<UserFile> selectFolderByUserIdPathState(@Param("userId") String userId, @Param("path") String path,
			@Param("state") Byte state);
	...
	int moveUserFile2(@Param("userFileName") String userFileName,@Param("path") String path, @Param("moveTo") String moveTo,@Param("userId") String userId);
